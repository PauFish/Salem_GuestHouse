  ...
  <footer class="footer">
    ...
    <div class="container">
      <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>If you get lost:</div>
                    <div>Go to the Petrol station (there is only one in Ras Al Hadd before entering the town) they will help you contacting me.</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Webside was made with colorlib></a></div>
        </div>
      </div>
    </div>
  </footer>
